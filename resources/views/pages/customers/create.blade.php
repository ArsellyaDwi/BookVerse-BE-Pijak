...
@section('content')
<div class="">
    <x-common.page-breadcrumb pageTitle="Add New Customer" />

    <x-common.component-card title="Customer Information" desc="Enter the customer details">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    @error('password')
                        <p class="text-theme-xs text-error-500 mt-1.5">{{ $message }}</p>
                    @enderror
                    <p class="text-theme-xs text-gray-500 mt-1.5">Password must be at least 8 characters</p>
                </div>
