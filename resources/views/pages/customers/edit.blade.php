...
<div class="">
    ...
    <x-common.component-card title="Edit Customer Information" desc="Update customer details">
        <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-theme-xs text-gray-500 mt-1.5">Leave blank to keep current password. Minimum 8 characters if changing.</p>
                </div>
