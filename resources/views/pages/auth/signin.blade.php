                            ...
                            <form method="POST" action="{{ route('auth.login.store') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        @error('email')
                                            <span class="text-error-500 text-sm mt-1 block">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <div class="text-center">
                                <h2 class="text-2xl font-bold text-white dark:text-white">Book Verse Admin</h2>
                            </div>
                        </a>
                    </div>
                </div>
