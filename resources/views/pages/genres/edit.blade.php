...
<div class="">
    ...
    <x-common.component-card title="Genre Information" desc="Update the details for this genre">
        <form action="{{ route('admin.genres.update', $genre) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="remove_image" value="1" id="remove_image" class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500">
                            <label for="remove_image" class="ml-2 text-sm text-red-600 dark:text-red-400">
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $genre->image ? 'Replace Image' : 'Genre Image' }}
                    </label>
                    ...
                    <div x-data="{
                        ...
                        <div 
                            ...
                            <input x-ref="fileInput" type="file" name="image" @change="handleFiles(Array.from($event.target.files))" accept="image/png,image/jpeg,image/jpg,image/webp,image/gif" class="hidden" />

                            <div x-show="previewUrl" x-cloak class="mb-4 flex justify-center">
                                <img :src="previewUrl" alt="Preview" class="h-32 w-32 object-cover rounded-lg border-2 border-brand-500 shadow-lg">
                            </div>

                            <div x-show="!previewUrl" class="flex flex-col items-center m-0">
                                ...
                                <h4 class="mb-3 font-semibold text-gray-800 text-theme-xl dark:text-white/90">
                                    <span x-show="!isDragging">Drag & Drop Image Here</span>
                                ...
                                <span class="text-center mb-5 block w-full max-w-[290px] text-sm text-gray-700 dark:text-gray-400">
                                    Drag and drop your PNG, JPG, JPEG, GIF, WebP image here or browse
                                </span>
                    ...
                    <p class="text-theme-xs text-gray-500 mt-1.5">Upload an image for this genre (optional). Accepted formats: PNG, JPG, JPEG, GIF, WebP. Max size: 2MB</p>
                </div>
