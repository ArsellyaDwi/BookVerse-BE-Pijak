...
@section('content')
<div class="">
    <x-common.page-breadcrumb pageTitle="Add Emotion Dataset" />

    <x-common.component-card title="Dataset Information" desc="Enter the emotion label and text content">
        <form action="{{ route('admin.ai.emotion-datasets.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="text" 
                              ...
                              placeholder="Enter the text content for emotion analysis...">{{ old('text') }}</textarea>
                    
                    @error('text')
                        <p class="text-theme-xs text-error-500 mt-1.5">{{ $message }}</p>
                    @enderror
                    
                    <p class="text-theme-xs text-gray-500 mt-1.5">Enter the text that will be used for training the emotion detection model.</p>
                </div>
