<div x-data="{
    ...
    async submitForm() {
        ...
        try {
            const response = await fetch('{{ route("admin.ai.emotion-datasets.import") }}', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                window.location.href = '{{ route("admin.ai.emotion-datasets.index") }}';
            } else {
                alert(result.error || 'Error importing file');
    ...
    <div class="fixed inset-0 z-99999 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black/50 p-4">
        <div class="relative w-full max-w-2xl rounded-2xl bg-white shadow-xl dark:bg-gray-900">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-800">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90">Import Emotion Datasets from CSV</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Upload a CSV file to bulk import training data</p>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-6 rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
                    ...
                    <ul class="list-inside list-disc space-y-1 text-sm text-blue-700 dark:text-blue-300">
                        <li>First row must contain column headers: <strong>labels, text</strong></li>
                        <li><strong>labels:</strong> Emotion label (e.g., happy, sad, angry, fear, surprise, love, neutral)</li>
                        <li><strong>text:</strong> The text content to analyze</li>
                        <li>Maximum file size: 10MB</li>
                        <li>Invalid rows will be automatically skipped</li>
                        <li>Duplicate entries (same label and text) will be skipped</li>
                    </ul>
                    <div class="mt-3">
                        <a href="{{ route('admin.ai.emotion-datasets.download-template') }}" 
                ...
                <div class="mt-4 space-y-2">
                    <div class="rounded-lg bg-green-50 p-3 dark:bg-green-900/20">
                        <p class="text-sm text-green-800 dark:text-green-300">
                            <strong>✓ Valid rows will be imported</strong> - All valid label-text pairs will be added to your training dataset
                        </p>
                    </div>
                    <div class="rounded-lg bg-yellow-50 p-3 dark:bg-yellow-900/20">
                        <p class="text-sm text-yellow-800 dark:text-yellow-300">
                            <strong>⚠ Invalid or duplicate rows will be skipped automatically</strong> - Rows with missing fields or duplicates will be ignored
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 p-4 dark:border-gray-800">
                ...
                <button @click="submitForm" 
                    ...
                    <span x-show="!uploading">Import Datasets</span>
