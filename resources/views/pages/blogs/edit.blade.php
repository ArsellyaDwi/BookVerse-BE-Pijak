...
<div class="">
    ...
    <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            <x-common.component-card title="Blog Post Information" desc="Edit blog post">
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="read_time" value="{{ old('read_time', $blog->read_time) }}" placeholder="5 min read"
                ...
                <div class="mt-4">
                    ...
                    <textarea name="short_description" rows="3"
                        ...
                        placeholder="Brief summary...">{{ old('short_description', $blog->short_description) }}</textarea>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="content" rows="10"
                        ...
                        placeholder="Full article content...">{{ old('content', $blog->content) }}</textarea>
                    @error('content')
                        <p class="text-theme-xs text-error-500 mt-1.5">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <x-common.component-card title="Featured Image" desc="Upload a cover image for the blog post">
                @if($blog->featured_image)
                    <div class="mb-4">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Current Image</label>
            ...
            <x-common.component-card title="Publish Options" desc="Configure publishing settings">
                <div class="flex items-center gap-3">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_published" value="1" {{ old('is_published', $blog->is_published) ? 'checked' : '' }} class="w-4 h-4 text-brand-500 rounded">
