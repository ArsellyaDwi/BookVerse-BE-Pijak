...
@section('content')
<div class="">
    <x-common.page-breadcrumb pageTitle="Add Payment Method" />

    <x-common.component-card title="Payment Method Information" desc="Enter the details for the new payment method">
        <form action="{{ route('admin.payment-methods.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-theme-xs text-gray-500 mt-1.5">Enter a unique payment method name.</p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Enter a description for this payment method (optional)">{{ old('description') }}</textarea>
                    
                    @error('description')
                        <p class="text-theme-xs text-error-500 mt-1.5">{{ $message }}</p>
                    @enderror
                    
                    <p class="text-theme-xs text-gray-500 mt-1.5">Provide additional information about this payment method.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-theme-xs text-gray-500 mt-1.5">Upload an image/icon for this payment method (optional).</p>
                </div>
